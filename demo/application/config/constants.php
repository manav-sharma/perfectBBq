...
define('SITE_URL', 				'http://' . $_SERVER['HTTP_HOST'] . '/projects/bbq/demo/');
define('ADMIN_SITE_URL', 		'http://' . $_SERVER['HTTP_HOST'] . '/projects/bbq/demo/admin/');

#define('SITE_URL', 				'http://' . $_SERVER['HTTP_HOST'] . '/projects/ureap/development/');
#define('ADMIN_SITE_URL', 		'http://' . $_SERVER['HTTP_HOST'] . '/projects/ureap/development/admin/');
...
define('JS_PATH',  				SITE_URL."common/scripts/");
define('CSS_PATH',  			SITE_URL."common/styles/");

define('ADMIN_JS_PATH',  		SITE_URL."common/scripts/admin/");
define('ADMIN_CSS_PATH',  		SITE_URL."common/styles/admin/");

define('FRONTEND_IMAGE',		SITE_URL."common/media/");
...
define('CMS_UPLOADS_image',			SITE_URL."common/images/");

define('SUPPORT_EMAIL',			"support@ureap.co.za");
define('SITE_NAME',			"Ureap");

/*
 * Payfast Merchant Credentials
 */
define('payfast_merchant_id',			"10004235");
define('payfast_merchant_key',			"sxiqx5b48poxy");
/***************************/
