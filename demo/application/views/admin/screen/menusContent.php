<?php
$data['scripts'][] = 'admin/cmsmenusContent.js'; 
$data['validate']	='menusContent';
...
<div id="pageContent">
    <?php
		$attributes = array('id' => 'menusContent', 'name' => 'menuscontent');
		echo form_open('admin/menuscontent', $attributes);
    ?>
                        ...
                        if ($status == 1) {
                            ...
                            echo 'Inactive';
                               ...
                               <td style="vertical-align: middle;">
                                    <select class="selActions" id="<?php echo $val->mnuId; ?>" name="selActions">
                                        <option value="">Actions</option>   
                                        <option value="managelinks">Manage Links</option> 
                                    </select>
                                </td>
                            </tr>
                            <?php
