...
if (empty($detail)) {
    ...
    echo form_open_multipart('admin/screen/addScreen', $attributes);
} else {
    $attributes = array('id' => 'addeditpage', 'name' => 'addeditpage');
    echo form_open_multipart('admin/screen/editScreen/' . $detail['id'], $attributes); ?>
...
<div id="pageHeading"> 
    <div class="column1">
        ...
        <div id="breadcrumb">
            ...
            <span class="pipe">&#187;</span> <a href="<?php echo site_url('admin/screen'); ?>">Page</a>
            <span class="pipe">&#187;</span> <?php echo ucwords(isset($title) ? $title : ""); ?>
        </div>
    </div>
	<div class="column2"> 
		<a class="btn" href="<?php echo site_url('admin/screen'); ?>">Back</a>  
