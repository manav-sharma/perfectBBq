...
<div id="pageHeading"> 
    ...
    <div class="column2">
        <!--<a href="<?php echo site_url('admin/users/addAdvertiser'); ?>" class="btn">Register</a>-->
    </div>
...
<div id="pageContent">
    ...
    echo form_open('admin/appusers/appuserlist', $attributes);
    ?>
                            ...
                            <tr class="<?php echo $class; ?>">
                                ...
                                <td style="vertical-align: middle;">
                                    <select class="selActions" id="<?php echo $val->user_id; ?>" name="advertiser">
                                        ...
                                        <option value="editappuser">Edit</option>
