...
echo form_open_multipart('admin/category/addCategory', $attributes);
?> 
            ...
            <dd>
                <table border="0" cellspacing="0" cellpadding="0" style=" margin-top:18px" class="form" >
                    ...
                    <tr>
                        ...
                        <td scope="col">
							<input type="file" name="txtAdvImage" id="txtAdvImage" data-errormessage-value-missing="Image is required!" class="validate[required,funcCall[validateVideoType]]" />
						</td>
                    </tr>
                    ...
                    <tr>
						...
						<td scope="col">
							<input name="txtAdvSwitch" value="1" type="radio" class="radioBtn" />On
							<input name="txtAdvSwitch" value="0" type="radio" checked="checked" class="radioBtn" />Off
						</td>
						<td>&nbsp;</td>
						<td scope="col">
							<label>Layout:</label>
					...
					<tr>
						...
						<td scope="col">
							<input type="text" data-errormessage-value-missing="This field is required!" class="validate[required,custom[onlyNumber]]" name="txtPosition" id="txtPosition" maxlength="60" value="" />
						</td>
					</tr>
