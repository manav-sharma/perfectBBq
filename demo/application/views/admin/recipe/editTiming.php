            ...
            <dd>
                <table border="2" cellspacing="0" cellpadding="0" style=" margin-top:18px" class="form" >
                    ...
                    <tr>
                        ...
                        <?php } ?>
                        <td scope="col"><input type="text" data-errormessage-value-missing="Minutes are required!" class="validate[required,custom[onlyNumber],min[0]] minData" size="10" name="min" value="<?php echo $detail->recTimeMin; ?>"/></td>
                        <td scope="col">
