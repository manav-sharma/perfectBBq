...
echo form_open_multipart('admin/recipe/editInterval/'.$detail->recIntervalId, $attributes);
?> 
 <input type="hidden" value="<?=$detail->recIntervalId?>" name="rec_interval_id">
            ...
            <dd>
                <table border="0" cellspacing="0" cellpadding="0" style=" margin-top:18px" class="form" >
                    ...
                    <tr>
                        ...
                        <td scope="col">
							<input type="text" data-errormessage-value-missing="This field is required!" class="validate[required]" size="26" name="txtTitleEng" id="txtTitleEng" maxlength="60" value="<?=$detail->recIntervalTitleEng ?>"/>
						</td>
						<td>&nbsp;</td>
						<td scope="col"><label>Title (In German):</label></td>
                        <td scope="col">
							<input type="text" data-errormessage-value-missing="This field is required!" class="validate[required]" size="26" name="txtTitleDutch" id="txtTitleDutch" maxlength="60" value="<?=$detail->recIntervalTitleDutch ?>" />
						</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td scope="col">
							<textarea name="txtDescEng" id="txtDescEng"><?=$detail->recIntervalDescEng ?></textarea>
						</td>
						<td>&nbsp;</td>
						<td scope="col"><label>Description (In German):</label></td>
                        <td scope="col">
							<textarea name="txtDescDutch" id="txtDescDutch"><?=$detail->recIntervalDescDutch ?></textarea>
						</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td scope="col">
							<input type="text" data-errormessage-value-missing="Minutes are required!" class="validate[required,custom[onlyNumber],min[0]] minData" size="10" name="min" value="<?=$detail->recIntervalTimeMin ?>"/>
						</td>
						<td>&nbsp;</td>
                        <td scope="col"><label>Time (In Sec):</label></td>
                        <td scope="col">
							<input type="text" data-errormessage-value-missing="Seconds are required!" class="validate[required,custom[onlyNumber],min[0],max[60]] secData" size="10" name="sec" value="<?=$detail->recIntervalTimeSec ?>"/>
						</td>
                    </tr>
                </table>
                <input type="hidden" value="<?=$detail->recIntervalTotalSec ?>" class="rec_total_sec" name="recTotalSec">                                
            </dd>
            <div class="clear"></div>
        </dl>
        <div class="baseStrip">
