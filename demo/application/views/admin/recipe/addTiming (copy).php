                ...
                <table border="2" cellspacing="0" cellpadding="0" style=" margin-top:18px" class="form  recipe-table" >
                    ...
                    <?php if (trim($tempMode) == 'yes' && trim($thickMode) == 'yes') { ?>
						...
						<tr>
							...
							<td scope="col"><input type="text" data-errormessage-value-missing="Minutes are required!" class="validate[required,custom[onlyNumber],min[0],max[60]] minData" size="10" name="min[]" value=""/></td>
							<td scope="col">
