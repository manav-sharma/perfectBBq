            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tbody>
                    <tr>
                        <th scope="col">
                            <input type="radio" name="sortBy" 
                                value='item_<?php echo ((isset($sortBy) && $sortBy == "item") ? ($orderBy) : 'asc'); ?>' 
                                id="item" class="hidden" 
                                <?php echo ((isset($sortBy) && $sortBy == "item") ? "checked='checked'" : ""); ?> />
                            <label for="item" class="radioSubmitClass" >
                                <a class="sorting 
                                    <?php echo ((!empty($sortBy) && $sortBy == "item") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >
                                    Item
                                </a>
                            </label>
                        </th>              
                        <!--<th scope="col">
                            <input type="radio" name="sortBy" 
                                value='item_name_<?php echo ((isset($sortBy) && $sortBy == "item_name") ? ($orderBy) : 'asc'); ?>' 
                                id="item_name" class="hidden" 
                                <?php echo ((isset($sortBy) && $sortBy == "item_name") ? "checked='checked'" : ""); ?> />
                            <label for="item_name" class="radioSubmitClass" >
                                <a class="sorting 
                                    <?php echo ((!empty($sortBy) && $sortBy == "item_name") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >
                                    Item Name
                                </a>
                            </label>
                        </th>    -->          
                        ...
                        <th scope="col">
                            <input type="radio" name="sortBy" 
                                value='credit_type_<?php echo ((isset($sortBy) && $sortBy == "credit_type") ? ($orderBy) : 'asc'); ?>' 
                                id="credit_type" class="hidden" 
                                <?php echo ((isset($sortBy) && $sortBy == "credit_type") ? "checked='checked'" : ""); ?> />
                            <label for="credit_type" class="radioSubmitClass" >
                                <a class="sorting 
                                    <?php echo ((!empty($sortBy) && $sortBy == "credit_type") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >	Credit / Debit
                                </a>
                            </label>
                        </th>
                        <th scope="col">
                            ...
                            <label for="credit_points" class="radioSubmitClass" >
                                <a class="sorting 
                                    <?php echo ((!empty($sortBy) && $sortBy == "credit_points") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >	Credit Points
                                </a>
                            </label>
                        </th>
                        <th scope="col">
                    ...
                    <tr class="filter">
                        ...
                        <td></td>
                        <td>
                            <input type="text" value="<?php echo isset($postData['txtItemName']) ? $postData['txtItemName'] : ''; ?>"
                                class="" name="txtItemName" maxlength="100" />
                        </td>
                        <td></td>
                        <td></td>
                    ...
                    if ($total_users > 0) 
                    {
                        ...
                        foreach ($userListing as $val)
                        {
                            ...
                            <tr class="<?php echo $class; ?>">
                                ...
                                <td style="vertical-align: middle;">  <?php echo ucwords(isset($val->item) ? $val->item : "&nbsp;"); ?>
                                </td>
                                <td title="<?php echo ucwords(isset($val->item_name) ? $val->item_name : "&nbsp;"); ?>" style="vertical-align: middle;">    <?php echo ucwords(isset($val->item_name) ? $val->item_name : "&nbsp;"); ?>
                                </td>
                                <td style="vertical-align: middle;">
                                    <?php echo $val->credit_type; ?>
                                </td>
                                <td style="vertical-align: middle;">
