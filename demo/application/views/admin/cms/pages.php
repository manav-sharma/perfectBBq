...
<div id="pageHeading"> 
    ...
    <div class="column2">
        <a href="<?php echo site_url('admin/pages/addpage'); ?>" class="btn">Add New Page</a>
    </div>
...
<div id="pageContent">
    <?php
    $attributes = array('id' => 'pages', 'name' => 'pages');
    echo form_open('admin/pages', $attributes);
    ?>
    ...
    <div class="stdListingWrapper">
        <dl id="actionBar">
            ...
            <dd> Select: <a href="javascript:void(0)" id="selectAll">All</a> l <a href="javascript:void(0)" id="selectNone">None</a> &nbsp;&nbsp;<strong>Actions</strong>
                <select id="cmbActions" style="width:auto;" name="page">
                    ...
                    <tr>
                        ...
                        <th scope="col">
                            ...
                            <label for="cmsTitleEng" class="radioSubmitClass" >
                                <a class="sorting <?php echo ((isset($sortBy) && $sortBy == "cmsTitleEng") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >Title (In Eng)</a>
                            </label>
                        </th>
                        ...
                        <th scope="col">
                            <input type="radio" name="sortBy" value='cmsContentEng_<?php echo ((isset($sortBy) && $sortBy == "cmsContentEng") ? ($orderBy) : 'asc'); ?>' id="cmsContentEng" class="hidden" <?php echo ((isset($sortBy) && $sortBy == "cmsContentEng") ? "checked='checked'" : ""); ?> />
                            <label for="cmsContentEng" class="radioSubmitClass" >
                                <a class="sorting <?php echo ((isset($sortBy) && $sortBy == "cmsContentEng") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >Description (In Eng)</a>
                            </label>
                        </th>
                        
                        <th scope="col">
                            <input type="radio" name="sortBy" value='cmsContentDutch_<?php echo ((isset($sortBy) && $sortBy == "cmsContentDutch") ? ($orderBy) : 'asc'); ?>' id="cmsContentDutch" class="hidden" <?php echo ((isset($sortBy) && $sortBy == "cmsContentDutch") ? "checked='checked'" : ""); ?> />
                            <label for="cmsContentDutch" class="radioSubmitClass" >
                                <a class="sorting <?php echo ((isset($sortBy) && $sortBy == "cmsContentDutch") ? ("sort" . ucfirst($orderBy)) : ''); ?>" >Description (In German)</a>
                            </label>
                        </th>
                        ...
                        if ($status == 1) {
                            ...
                            echo 'Inactive';
                               ...
                               <td style="vertical-align: middle;">
                                    <select class="selActions" id="<?php echo $val->cmsid; ?>" name="page">
                                        <option value="">Actions</option>   
                                        <option value="editpage">Edit</option>
                                        <option value="active">Activate</option>
                                        <option value="inactive">Inactivate</option>
                                        <option value="delete">Delete</option>
