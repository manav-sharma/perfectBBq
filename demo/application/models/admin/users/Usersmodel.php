...
class Usersmodel extends CI_Model {
    ...
    function getLoginResult($username, $password) {
        ...
        $this->db->where('user.user_type!=', 'app_user');
        $str = $this->db->get();
        $final = $str->result();
    ...
    function updateAdminPassword($email, $newPassword) {
        ...
        $this->db->update('user', array("password_hash " => md5($newPassword)));
        return true;
    }
  ...
  public function editAdvertiserProfile($usrId) {
    ...
    public function editAdvertiserData($usrId) {
        ...
        $advertiserDetails = array(
            ...
            'cmpAddress' =>  $this->input->post('caddress'),
            'cmpPhone' =>  $this->input->post('cphone'),
            'user_type' => $this->input->post('usrType'),
        );
    ...
    public function editAppUserData($usrId) {
        ...
        $advertiserDetails = array(
            ...
            'lname' => $this->input->post('lname'),
            'phone' => $this->input->post('phone'),            
            'age' => $this->input->post('cmbAge'),
            'race' => $this->input->post('cmbRace'),
            'gender' => $this->input->post('cmbGender'),
            'nationality' => $this->input->post('cmbNationality')
        );
