                ...
                if ($this->hybridauthlib->providerEnabled($provider))
                {
                        ...
                        if ($service->isUserConnected())
                        {
                                ...
                                $userProfile = array(
                                        ...
                                        'phone' => isset($user_profile['phone'])?$user_profile['phone']:'',
                                        'organization_name' => isset($user_profile['organization_name'])?$user_profile['organization_name']:'',
                                
                                );
                                $userProfile['genderType'] = ($user_profile['gender'] == 'male')?'m':'f';
                                  
                                $this->session->set_flashdata('new_userprofile',$userProfile);    
